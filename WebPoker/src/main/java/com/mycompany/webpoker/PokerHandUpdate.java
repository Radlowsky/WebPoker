...
/**
 * class that contains update to database
 *
 * @version 5.0
 * @author Jeremiasz Radłowski
 */
@WebServlet(name = "PokerHandUpdate", urlPatterns = {"/PokerHandUpdate"})
public class PokerHandUpdate extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<div>Select your cards</div>\n"
                    + "<form name=\"checkForm\" action=\"updateHand\">\n"
                    + " <label>Id:\n"
                    + "     <select name=\"Id\">\n");
            for (var i : listOfHand) {
            ...
            out.println("<div>Select your cards</div>\n"
                    ...
                    + "                </select>\n"
                    + "            </label><br>\n"
                    + "            <input type=\"submit\" value=\"UPDATE!\" name=\"updateHand\" />\n"
                    + "        </form>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(PokerHandUpdate.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
